      ...
      <Box>
        <Box as='span' mr={3}>
          <a href='https://play.google.com/store/apps/details?id=org.openobservatory.ooniprobe' target='_blank'>
            <Image src="/static/images/google-play-badge.svg" alt="Download ooniprobe for Android" height="56" width="189" />
          </a>
        </Box>
        <Box as='span' mr={3}>
          <a href='https://itunes.apple.com/us/app/id1199566366' target='_blank'>
            <Image src="/static/images/apple-store-badge.svg" alt="Download ooniprobe for iOS" height="56" width="168" />
          </a>
        </Box>
        <Box as='span' mr={3}>
          <a href='https://f-droid.org/repository/browse/?fdid=org.openobservatory.ooniprobe' target='_blank'>
            <Image src="/static/images/fdroid-badge.svg" alt="Download ooniprobe for Android (F-Droid)" height="56" width="189" />
          </a>
        </Box>
      </Box>
    </Box>
